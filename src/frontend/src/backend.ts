...
export class Backend implements backendInterface {
    ...
    async getPrayerTimesForCity(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrayerTimesForCity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSelectedCity(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getSelectedCity();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodaysHijriDate(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysHijriDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserPrayerTimes(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserPrayerTimes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setSelectedCity(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSelectedCity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
